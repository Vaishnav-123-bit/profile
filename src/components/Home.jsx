            ...
            <div>
                <div className='flex flex-col md:flex-row items-center justify-between w-full'>
                    ...
                    <div className='text-white'>
                        ...
                        <h1 className='font-semibold md:text-5xl my-4 text-3xl'>Vaishnav Mahadik</h1>
                        ...
                        <div className='mt-5'>
                            <button className='btn transition-all duration-500 bg-primary py-2 px-4 rounded text-white hover:bg-white hover:text-blue-900'>About me</button> 
